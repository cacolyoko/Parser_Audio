...
def main():
    ...
    try:
        ...
        world.debug.draw_string(spawn_point_1.location, 'Spawn Point 1', life_time=30, color=carla.Color(0,0,255))
        world.debug.draw_string(spawn_point_2.location, 'Spawn Point 2', life_time=30, color=carla.Color(0,255,0))
        ...
        for ind in route_2_indices:
            spawn_points[ind].location
            world.debug.draw_string(spawn_points[ind].location, str(ind), life_time=60, color=carla.Color(0,255,0))
